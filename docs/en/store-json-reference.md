...
| `migrations` | object | No | Database migration scripts |
...
Database migration scripts executed during install (up) and uninstall (down):
...
- **receiptFiles**: Required files that must exist in the shop
